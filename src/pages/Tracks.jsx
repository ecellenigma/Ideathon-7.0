...
const Tracks = () => {
    ...
    return (
        <section id="tracks" className="text-white relative flex flex-col items-center min-h-screen snap-start" onMouseMove={handleMouseMove}>
            <h1 className="mx-auto mt-20 mb-12 text-center text-5xl md:text-6xl font-[900] font-['Outfit'] uppercase tracking-widest text-transparent bg-clip-text bg-gradient-to-r from-[#FF6A2E] to-[#FF9A03]">
                Tracks
            </h1>
            ...
            <div className="grid p-5  grid-cols-1 md:grid-cols-2 gap-16 max-w-6xl mx-auto">
                <Tilt className="Tilt" tiltMaxAngleX={6.5} tiltMaxAngleY={6.5} scale={1.03} transitionSpeed={2000}>
                    <div className="Tilt-inner border border-[#FF6A2E] rounded-2xl p-8 bg-[#080302] shadow-[0_0_4px_rgba(255,106,46,0.5)] flex flex-col items-start justify-start mb-12 transition-all duration-500 cursor-pointer hover:shadow-[0_0_16px_rgb(255,138,6)] h-auto md:h-full">
                        ...
                        <p className="lg:text-[4vh] md:text-[3vh] text-[#FF6A2E] mb-3 font-['Montserrat'] text-left">
                            Prototype Track
                        </p>
                ...
                <Tilt className="Tilt" tiltMaxAngleX={6.5} tiltMaxAngleY={6.5} scale={1.03} transitionSpeed={2500}>
                    <div className="Tilt-inner border border-[#FF6A2E] rounded-2xl p-8 bg-[#080302] shadow-[0_0_4px_rgba(255,106,46,0.5)] flex flex-col items-start justify-start mb-12 transition-all duration-500 cursor-pointer hover:shadow-[0_0_16px_rgb(255,138,6)] h-auto md:h-full">
                        ...
                        <p className="lg:text-[4vh] md:text-[3vh] text-[#FF6A2E] font-medium mb-3 font-['Montserrat'] text-left">
                            Ideation Track
                        </p>
                        <p className="text-white lg:text-[3vh] md:text-[2vh] leading-tight font-['Montserrat'] text-left">
